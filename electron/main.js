...
function seedDefaultUsers() {
  try {
    ...
    db.prepare("UPDATE system_users SET barcode = 'USER-super_admin-u1' WHERE username = 'superadmin' AND (barcode IS NULL OR barcode = 'DEV-0000')").run();
    db.prepare("UPDATE system_users SET barcode = 'USER-owner-u2'       WHERE username = 'admin'      AND (barcode IS NULL OR barcode = 'OWN-1234')").run();
    db.prepare("UPDATE system_users SET barcode = 'USER-manager-u3'     WHERE username = 'manager'    AND (barcode IS NULL OR barcode = 'MGR-5678')").run();
    db.prepare("UPDATE system_users SET barcode = 'USER-staff-u4'       WHERE username = 'cashier'    AND (barcode IS NULL OR barcode = 'STF-1111')").run();
  } catch(e) {
